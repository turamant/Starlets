...
class Tk(tkinter.Tk, tixCommand):
    ...
    def __init__(self, screenName=None, baseName=None, className='Tix'):
        ...
        # If it's statics, tcl/tix8.1/pkgIndex.tcl should have
        #               'load {} Tix'
...
class TixWidget(tkinter.Widget):
    ...
    Widget initialization is extended in two ways:
       ...
       the creation command (so called Tix 'statics' options). These cannot be
    ...
    def __init__ (self, master=None, widgetName=None,
        ...
        # Move statics options into extra. static_options must be
        # a list of keywords (or None).
        extra=()

        # 'options' is always a statics option
        if static_options:
        ...
        # Non-statics options - to be done via a 'config' command
        if cnf:
...
class Balloon(TixWidget):
    ...
    def __init__(self, master=None, cnf={}, **kw):
        # statics seem to be -installcolormap -initwait -statusbar -cursor
...
class ResizeHandle(TixWidget):
    ...
    def __init__(self, master, cnf={}, **kw):
        ...
        # Let's try making the flags -statics
