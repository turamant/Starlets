...
class _Any(_FinalTypingBase, _root=True):
    ...
    statics type checkers. At runtime, Any should not be used with instance
    or class checks.
    """
...
class _NoReturn(_FinalTypingBase, _root=True):
    ...
    will fail in statics type checkers.
    """
...
class TypeVar(_TypingBase, _root=True):
    ...
    Type variables exist primarily for the benefit of statics type
...
def NewType(name, tp):
    ...
    by statics type checkers. At runtime, NewType(name, tp) returns
